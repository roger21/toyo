...
<html lang="fr">
  <head>
    ...
    <meta name="keywords" content="hfr toyonos smiley helper">
      ...
      <div id="infos_area">
        ...
        <div id="preview_area">
          <div>
            ...
            <input id="ratio_left" type="text" maxlength="2" spellcheck="false" value="7" disabled="disabled" pattern="[1-9]([0-9])?" title="entre 1 et 99">
            <p>:</p>
            <input id="ratio_right" type="text" maxlength="2" spellcheck="false" value="5" disabled="disabled" pattern="[1-9]([0-9])?" title="entre 1 et 99">
