...
#### 6. pseudals.txt contient les pseudos et les "citations personnelle associée au pseudo" des profils au jeudi 11 décembre 2025

- existant et ayant un avatar, une "citations personnelle associée au pseudo" et au moins 10 000 posts au lundi 13 juillet 2020 ;
- ayant un avatar, une "citations personnelle associée au pseudo" et au moins 10 000 posts au 11 décembre 2025 ;
- n'ayant **pas** posté depuis plus d'un an au 11 décembre 2025 (en gros) ;
- et dont la "citations personnelle associée au pseudo" ne contient pas de caractère non géré par la police d'écriture du générateur :

```sql
WITH old AS (SELECT pseudal FROM old.p WHERE avatarurl IS NOT NULL AND btrim(quote, U&'\000A\000B\000C\000D\0009\0020\0085\2028\2029') != '' AND nbposts > 10000)
SELECT pseudal || ';' || btrim(quote, U&'\000A\000B\000C\000D\0009\0020\0085\2028\2029') FROM new.p NATURAL JOIN old
WHERE avatarurl IS NOT NULL AND btrim(quote, U&'\000A\000B\000C\000D\0009\0020\0085\2028\2029') != '' AND nbposts > 10000 AND date - lastpostdate > interval '1 year'
```
...
```sql
SELECT btrim(signature, U&'\000A\000B\000C\000D\0009\0020\0085\2028\2029') FROM p WHERE
btrim(signature, U&'\000A\000B\000C\000D\0009\0020\0085\2028\2029') != '' AND
date - lastpostdate < interval '1 year'
```
